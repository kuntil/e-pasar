              ...
              <table class="table table-bcommented table-hover table-bordered">
				...
				?>
					...
					<tr>
						...
						<td><?php echo $no;?></td>
						<td><?php echo $comment->buyer_name;?>
						...
						<td><a href="<?php echo base_url();?>comment/detail_comment?id=<?php echo $qid;?>" class="btn btn-success btn-flat btn-sm">Balas Komentar</a></td>
