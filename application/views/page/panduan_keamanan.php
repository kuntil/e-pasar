	  ...
	  <div class="col-md-12">
          ...
          <div class="box box-warning box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">Panduan Keamanan</h3>
            </div>
			 <div class="box-body">
			 <table class="table">
			  <?php foreach($pandu as $pandu){ ?>
				<tr>
				
					<td style="width: 10px">
						<div class="col-md-12">
							<img src="<?php echo base_url();?>asset/dist/img/privacy.png" width="120" height="120">
							
						</div>
					</td>
					<td>
						<div class="col-md-12">
							 <h3><?php echo $pandu->title;?></h3>
							 <?php echo $pandu->content;?>
						</div>
