	  ...
	  <div class="col-md-12">
          ...
          <div class="box box-warning box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">Jaminan Aman</h3>
            </div>
			 <div class="box-body">
			 <table class="table">
			  <?php foreach($jamin as $jamin){ ?>
				<tr>
				
					<td style="width: 10px">
						<div class="col-md-12">
							<img src="<?php echo base_url();?>asset/dist/img/keamanan.png" width="120" height="120">
							
						</div>
					</td>
					<td>
						<div class="col-md-12">
							 <h3><?php echo $jamin->title;?></h3>
							 <?php echo $jamin->content;?>
						</div>
