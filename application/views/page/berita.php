			 ...
			 <table class="table">
			  <?php foreach($berita as $berita){ ?>
				<tr>
					<td style="width: 10px">
						<div class="col-md-12">
							<img src="<?php echo base_url();?>asset/dist/img/sampel.jpg" width="324" height="235">
					...
					<td>
						<div class="col-md-12">
							 ...
							 <?php 
								$words = explode(" ",$berita->content);
								$words2 = implode(" ",array_splice($words,0,50));	
								echo $words2;
							?>...
						</div>
						<div class="col-md-12">
							 <a href="" class="btn btn-primary btn-flat pull-right">Read More</a>
						</div>
    ...
    <div class="container">
						<div class="row">
							...
							<div class="col-md-2 margin-bottom-xs-30">
								...
								<a href="<?php echo base_url();?>pages/belanja" target="blank"><p><h8>Cara Belanja</a></p>
