	  ...
	  <div class="col-md-12">
          ...
          <div class="box box-warning box-solid">
            <div class="box-header with-border">
			 ...
			 <div class="box-body">
			 <table class="table">
			  <?php foreach($carbel as $carbel){ ?>
				<tr>
				
					<td style="width: 10px">
						<div class="col-md-12">
							<img src="<?php echo base_url();?>asset/dist/img/analytics.png" width="120" height="120">
							
						</div>
					</td>
					<td>
						<div class="col-md-12">
							 <h3><?php echo $carbel->tittle;?></h3>
							 <?php echo $carbel->content;?>
						</div>
