	  ...
	  <div class="col-md-12">
          ...
          <div class="box box-warning box-solid">
            <div class="box-header with-border">
			 ...
			 <div class="box-body">
			 <table class="table">
			  <?php foreach($tips_jual as $tips_jual){ ?>
				<tr>
				
					<td style="width: 10px">
						<div class="col-md-12">
							<img src="<?php echo base_url();?>asset/dist/img/tips_jual.png" width="120" height="120">
							
						</div>
					</td>
					<td>
						<div class="col-md-12">
							 <h3><?php echo $tips_jual->title;?></h3>
							 <?php echo $tips_jual->content;?>
						</div>
