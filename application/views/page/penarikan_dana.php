	  ...
	  <div class="col-md-12">
          ...
          <div class="box box-warning box-solid">
            <div class="box-header with-border">
              <h3 class="box-title">Penarikan Dana</h3>
            </div>
			 <div class="box-body">
			 <table class="table">
			  <?php foreach($tarik as $tarik){ ?>
				<tr>
				
					<td style="width: 10px">
						<div class="col-md-12">
							<img src="<?php echo base_url();?>asset/dist/img/penarikan.png" width="120" height="120">
							
						</div>
					</td>
					<td>
						<div class="col-md-12">
							 <h3><?php echo $tarik->title;?></h3>
							 <?php echo $tarik->content;?>
						</div>
