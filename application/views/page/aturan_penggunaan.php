			...
			<div class="col-lg-12 ">
				 <div class="box box-warning box-solid">
            		<div class="box-header with-border">
					  <h3 class="box-title">Aturan Penggunaan</h3>
					...
					<!-- /.box-header -->
					<div class="box-body">
							<!-- center> <img src="<?php echo base_url();?>asset/dist/img/team.jpg" width="320" height="320"/></center> -->
							
						<?php foreach($aturan as $aturan){ ?>
							<div class="col-md-12">
							<h3><?php echo $aturan->tittle;?></h3>							
							<?php 
								$words = explode(" ",$aturan->content);
								$words2 = implode(" ",array_splice($words,0,25));	
								echo $words2;
							?>...
							</div>
							
							<div class="col-md-12">
							 <a href="" class="btn btn-primary btn-flat pull-right">Selengkapnya</a>
							</div>
