              ...
              <table class="table table-bordered table-hover">
					...
					<tr>			
						...
						<td style="width: 200px">
								...
								<?php 
									$n = 0;
									$detail_order2= $this->m_order->transaction_cancel_buyer($order->order_id,$this->session->userdata('user_id')); 
								...
								<div class='alert alert-danger alert-dismissible'>Transaksi Di Batalkan</div>
						...
						<div id="demo<?php echo $order->order_id; ?>" class="collapse">
							<table class="table table-bordered table-condensed">
								...
								<?php $detail_order= $this->m_order->transaction_cancel_buyer($order->order_id,$this->session->userdata('user_id')); 
								$no2 = 1; 
								$n = 0;
