            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover table-bordered ">
                <tr>
                  ...
                  <th style="width:28%">Data Pembeli</th>
...
-->
                  ...
                  <td> 
				   ...
				   <?php 
					...
					<a href="<?php echo base_url();?>order/accept_order?id=<?php echo $order_id; ?>" class="btn btn-success" onClick="return confirm('Apakah Anda Menerima Pesanan Ini?')">Terima</a>
					<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#myModal<?php echo $or->order_id; ?>">Batal</button>
		...
		<div id="myModal<?php echo $or->order_id?>" class="modal fade modal-primary"" role="dialog">
			...
			<div class="modal-content">
              ...
              <div class="modal-body ">
					<textarea name="ignore_order" cols="40" rows="4" id="ignore_message" type="text" class="form-control" placeholder="Alasan Pembatalan Order" ></textarea>
					<input name="order_id" cols="40" rows="4" id="desc" type="hidden" class="form-control" value="<?php echo $or->order_id; ?>" >
					<input name="user_id" cols="40" rows="4" id="desc" type="hidden" class="form-control" value="<?php echo $or->user_id; ?>" >
					<input name="store_id" cols="40" rows="4" id="desc" type="hidden" class="form-control" value="<?php echo $or->store_id; ?>" >
              </div>
              </div>
