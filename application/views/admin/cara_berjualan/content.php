        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Cara Berjualan</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
					<div class=row>
						<div class="col-md-5 ">
							<div class="btn-group">
							<?php echo anchor('admin/cara_berjualan/add', 
						...
						<?php echo form_open("admin/cara_berjualan/find");?>
						<div class="col-md-7 ">
							<div class='col-md-4'>
							<?php $option = array(
									'title'=>'Judul',
					...
					<?php 
					$no = $number + 1;
					foreach ($cara_berjualan as $cara_berjualan) {
						$qid = base64_encode($this->encrypt->encode($cara_berjualan->qid, $this->session->userdata('encrypt_key')));
						?>
						<tr>
						  <td><?php echo $no?></td>
						  <td><?php echo $cara_berjualan->title;?></td>
						  <td><?php echo $cara_berjualan->content;?></td>
						  <td>
							<div><a href="<?php echo base_url();?>admin/cara_berjualan/modify?id=<?php echo $qid?>" class="btn btn-warning btn-flat" title="Ubah Cara Belanja">Edit</a>
							<a href="<?php echo base_url();?>admin/cara_berjualan/delete?id=<?php echo $qid?>"  onclick="return confirm('Anda Yakin ?');" class="btn btn-danger btn-flat" title="Hapus Cara Belanja" >Hapus</a></div>
						  </td>
						</tr>
					<?php 
					$no++;
